#EXTRACTING 3RD SET OF DATA FROM ORIGINAL TRAINING DATA
...
for i in range(0, 1000):
    ...
    score1 = mean_absolute_error(Y[i:i+1, :6], res1)
    print("The score is: %f" % score1)
    if (score1 > p2 + 2*scoref_2) and a is not None:
        print("This score is greater than the mean.")
        a = np.concatenate((a, X[i:i+1, :7]))
        b = np.concatenate((b, Y[i:i+1, :7]))
    else:
        print("It's not")
    if a is None and score1 > p2 + 2*scoref_2:
        a = np.array(X[i:i+1, :7])
        b = np.array(Y[i:i+1, :7])
# open a binary file in write mode
file1 = open("3tr2X", "wb")
...
for i in range(0, 1000):
    ...
    score1 = mean_absolute_error(Y[i:i+1, :6], res1)
    print("The score is: %f" % score1)
    if (score1 > p3 + 2*scoref_3) and a is not None:
        print("This score is greater than the mean.")
        a = np.concatenate((a, X[i:i+1, :7]))
        b = np.concatenate((b, Y[i:i+1, :7]))
    else:
        print("It's not")
    if a is None and score1 > p3 + 2*scoref_3:
        a = np.array(X[i:i+1, :7])
        b = np.array(Y[i:i+1, :7])
# open a binary file in write mode
file1 = open("3tr3X", "wb")
...
for i in range(0, 1000):
    ...
    score1 = mean_absolute_error(Y[i:i+1, :6], res1)
    print("The score is: %f" % score1)
    if (score1 > p4 + 2*scoref_4) and a is not None:
        print("This score is greater than the mean.")
        a = np.concatenate((a, X[i:i+1, :7]))
        b = np.concatenate((b, Y[i:i+1, :7]))
    else:
        print("It's not")
    if a is None and score1 > p4 + 2*scoref_4:
        a = np.array(X[i:i+1, :7])
        b = np.array(Y[i:i+1, :7])
# open a binary file in write mode
file1 = open("3tr4X", "wb")
...
for i in range(0, 1000):
    ...
    score1 = mean_absolute_error(Y[i:i+1, :6], res1)
    print("The score is: %f" % score1)
    if (score1 > p5 + 2*scoref_5) and a is not None:
        print("This score is greater than the mean.")
        a = np.concatenate((a, X[i:i+1, :7]))
        b = np.concatenate((b, Y[i:i+1, :7]))
    else:
        print("It's not")
    if a is None and score1 > p5 + 2*scoref_5:
        a = np.array(X[i:i+1, :7])
        b = np.array(Y[i:i+1, :7])
# open a binary file in write mode
file1 = open("3tr5X", "wb")
...
for i in range(0, 1000):
    ...
    score1 = mean_absolute_error(Y[i:i+1, :6], res1)
    print("The score is: %f" % score1)
    if (score1 > p6 + 2*scoref_6) and a is not None:
        print("This score is greater than the mean.")
        a = np.concatenate((a, X[i:i+1, :7]))
        b = np.concatenate((b, Y[i:i+1, :7]))
    else:
        print("It's not")
    if a is None and score1 > p6 + 2*scoref_6:
        a = np.array(X[i:i+1, :7])
        b = np.array(Y[i:i+1, :7])
# open a binary file in write mode
file1 = open("3tr6X", "wb")
