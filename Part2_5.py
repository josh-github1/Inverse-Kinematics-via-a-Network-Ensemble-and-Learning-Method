...
res_1 = m1.predict(X)
score_1 = mean_absolute_error(Y, res_1)
...
for i in range(0, 1000):
    ...
    score1 = mean_absolute_error(Y[i:i+1, :6], res1)
    print("The score is: %f" % score1)
    if (score1 > score_2) and a is not None:
        print("This score is greater than the mean.")
        a = np.concatenate((a, X[i:i+1, :7]))
        b = np.concatenate((b, Y[i:i+1, :7]))
    else:
        print("It's not")
    if a is None and score1 > score_2:
        a = np.array(X[i:i+1, :7])
        b = np.array(Y[i:i+1, :7])
# open a binary file in write mode
file1 = open("tr2X", "wb")
...
for i in range(0, 1000):
    ...
    score1 = mean_absolute_error(Y[i:i+1, :6], res1)
    print("The score is: %f" % score1)
    if (score1 > score_3) and a is not None:
        print("This score is greater than the mean.")
        a = np.concatenate((a, X[i:i+1, :7]))
        b = np.concatenate((b, Y[i:i+1, :7]))
    else:
        print("It's not")
    if a is None and score1 > score_3:
        a = np.array(X[i:i+1, :7])
        b = np.array(Y[i:i+1, :7])
# open a binary file in write mode
file1 = open("tr3X", "wb")
...
for i in range(0, 1000):
    ...
    score1 = mean_absolute_error(Y[i:i+1, :6], res1)
    print("The score is: %f" % score1)
    if (score1 > score_4) and a is not None:
        print("This score is greater than the mean.")
        a = np.concatenate((a, X[i:i+1, :7]))
        b = np.concatenate((b, Y[i:i+1, :7]))
    else:
        print("It's not")
    if a is None and score1 > score_4:
        a = np.array(X[i:i+1, :7])
        b = np.array(Y[i:i+1, :7])
# open a binary file in write mode
file1 = open("tr4X", "wb")
...
for i in range(0, 1000):
    ...
    score1 = mean_absolute_error(Y[i:i+1, :6], res1)
    print("The score is: %f" % score1)
    if (score1 > score_5) and a is not None:
        print("This score is greater than the mean.")
        a = np.concatenate((a, X[i:i+1, :7]))
        b = np.concatenate((b, Y[i:i+1, :7]))
    else:
        print("It's not")
    if a is None and score1 > score_5:
        a = np.array(X[i:i+1, :7])
        b = np.array(Y[i:i+1, :7])
# open a binary file in write mode
file1 = open("tr5X", "wb")
...
for i in range(0, 1000):
    ...
    score1 = mean_absolute_error(Y[i:i+1, :6], res1)
    print("The score is: %f" % score1)
    if (score1 > score_6) and a is not None:
        print("This score is greater than the mean.")
        a = np.concatenate((a, X[i:i+1, :7]))
        b = np.concatenate((b, Y[i:i+1, :7]))
    else:
        print("It's not")
    if a is None and score1 > score_6:
        a = np.array(X[i:i+1, :7])
        b = np.array(Y[i:i+1, :7])
# open a binary file in write mode
file1 = open("tr6X", "wb")
